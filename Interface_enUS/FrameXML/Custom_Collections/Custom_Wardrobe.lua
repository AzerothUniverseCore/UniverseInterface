...
--[[
			...
			if self.dependencySlot then
				...
				-- FIX ROUND TRANSMOG-49: TransmogUniverse.zip (the other,
				-- working system) NEVER calls Model:TryOn() with a plain
				-- NUMBER -- it systematically passes an item-link-type
				-- STRING ("item:12345:..."), even for the live drag-and-drop
				-- preview (playerModel:TryOn(itemLink)). Our branch
