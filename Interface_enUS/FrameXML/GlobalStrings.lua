...
ITEM_HEROIC = "|TInterface\\TooltipFrameCustom\\ui-heroic_tooltip_custom.blp:0|t|cff75c6e3 Heroic|r";
ITEM_HEROIC_EPIC = "Heroic Epic";
ITEM_HEROIC_EPIC_CUSTOM = "|TInterface\\TooltipFrameCustom\\ui-mythic_tooltip_custom.blp:0|t|cff31c7a5 Mythic|r";
...
STAT_MASTERY_TOOLTIP_NOT_KNOWN = "You must learn Mastery from your class trainer for this to take effect.";
STAT_MASTERY_TOOLTIP_NO_TALENT_SPEC = "You must select a talent specialization to enable Mastery.";
STAT_FORMAT = "%s:";
STAT_PARRY = "Parry";
...
TALENT_MASTERY_TOOLTIP_NOT_KNOWN = "You must learn Mastery from your class trainer.";
...
local DESTINY_LOCALIZATION = {
    ...
    ["LEVEL_UP_YOU_RECEIVED"] = {
        enUS = "You have received"
    },
    ["LEVEL_UP_UPS_RECEIVED"] = {
        enUS = "%d enhancement |4point:points;"
    },
    ["LEVEL_UP_YOU_REACHED"] = {
        enUS = "You have reached"
    },
    ["LEVEL_GAINED"] = {
        enUS = "Level %d"
    },
    ["LEVEL_UP_LEARN_NEW_SPELL"] = {
        enUS = "New ability learned"
    },
}
...
setmetatable(DESTINY_LOCALIZATION, {
    __call = function(self, key)
        ...
        return self[key].enUS -- Always return the (now English) localized version
    end
})
