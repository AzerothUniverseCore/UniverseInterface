ADVENTURE = ADVENTURE or "Dungeon Journal"
ADVENTURE_JOURNAL = ADVENTURE_JOURNAL or "Dungeon Journal"
...
HEADHUNTING = HEADHUNTING or "Head Hunting"
LOOTJOURNAL_ITEM_SETS = LOOTJOURNAL_ITEM_SETS or "Outfit"
...
ENCOUNTER_JOURNAL_ITEM = ENCOUNTER_JOURNAL_ITEM or "Topic"
...
ALL_INVENTORY_SLOTS = ALL_INVENTORY_SLOTS or "All Inventory Slots"
...
LOOTJOURNAL_ITEM_CLICK_TO_OPEN_LOOT = LOOTJOURNAL_ITEM_CLICK_TO_OPEN_LOOT or "Click to open loot."
LOOTJOURNAL_SOURCE_TOOLTIP_HEAD = LOOTJOURNAL_SOURCE_TOOLTIP_HEAD or "Tooltip"
LOOTJOURNAL_PVPICON_TOOLTIP_HEAD = LOOTJOURNAL_PVPICON_TOOLTIP_HEAD or "PvP Outfit"
LOOTJOURNAL_PVPICON_TOOLTIP = LOOTJOURNAL_PVPICON_TOOLTIP or "Gear suited for combat against other players."
RETURN_TO_DEFAULT = RETURN_TO_DEFAULT or "Default Settings"
...
DefItemSubClass("ITEM_SUB_CLASS_7_1", "Elemental")
...
DefItemSubClass("ITEM_SUB_CLASS_11_3", "Quiver")
...
DefItemSubClass("ITEM_SUB_CLASS_15_2", "Pet")
...
DefItemClass("ITEM_CLASS_8", "Enchanting")
DefItemClass("ITEM_CLASS_9", "Recipe")
DefItemClass("ITEM_CLASS_10", "Currency")
