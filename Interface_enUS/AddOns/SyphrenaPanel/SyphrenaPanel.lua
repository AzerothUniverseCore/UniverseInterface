...
do
	...
	-- Meme mecanisme que Mod_Me_PanelClient.lua / Mod_Me_ConvertClient.lua :
	-- detection via GetLocale(), repli sur frFR pour toute locale non geree.
	local UI_LOCALE = (GetLocale and GetLocale() == "enUS") and "enUS" or "frFR"

	local L = ({
		frFR = {
			TOOLTIP_TITLE = "Grimoire d'identité",
			TOOLTIP_DESC = "Informations sur votre personnage.",
		},
		enUS = {
			TOOLTIP_TITLE = "Identity Grimoire",
			TOOLTIP_DESC = "Information about your character.",
		},
	})[UI_LOCALE]
	...
	button:SetScript("OnEnter", function(self)
		...
		GameTooltip:AddLine(L.TOOLTIP_DESC, 1, 0.82, 0, true)
		GameTooltip:Show()
	end)
