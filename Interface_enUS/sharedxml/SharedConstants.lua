	...
	["HUNTER"] = {
		{
			...
			role = "DAMAGER",
			description = "Masters the art of the wild, adept at taming beasts of all kinds to fight alongside him in battle."
		},
		{
			name = "Marksmanship",
			icon = "Interface\\Icons\\Ability_Marksmanship",
			role = "DAMAGER",
			description = "A deadeye shot, unequaled at felling enemies from long range."
		},
		{
			name = "Survival",
			icon = "Interface\\Icons\\Ability_Hunter_SwiftStrike",
			role = "DAMAGER",
			description = "A tracker who prefers to rely on poisons, explosives, and traps."
		},
	},
	["WARRIOR"] = {
		{
			...
			role = "DAMAGER",
			description = "A seasoned master of two-handed weapons who relies on speed and the power of his blows in combat."
		},
		{
			name = "Fury",
			icon = "Interface\\Icons\\ability_warrior_innerrage",
			role = "DAMAGER",
			description = "An unbridled berserker wielding a weapon in each hand. He rains down a flurry of blows capable of shredding his enemy to pieces."
		},
		{
			name = "Protection",
			icon = "Interface\\Icons\\ability_warrior_defensivestance",
			role = "TANK",
			description = "An enduring defender who uses a shield to protect himself and his allies from enemy attacks."
		},
	},
	["PALADIN"] = {
		{
		...
		},
		{
			...
			role = "TANK",
			description = "A fearless guardian who uses the magic of the Light to protect himself and his allies from enemy attacks."
		},
		{
			name = "Retribution",
			icon = "Interface\\Icons\\spell_holy_auraoflight",
			role = "DAMAGER",
			description = "A champion of justice who punishes his enemies with his weapons and the magic of the Light."
		},
	},
	["ROGUE"] = {
		{
			...
			role = "DAMAGER",
			description = "A fearsome master of poisons who finishes off his opponents with envenomed daggers."
		},
		{
			name = "Combat",
			icon = "Interface\\Icons\\ability_backstab",
			role = "DAMAGER",
			description = "A nimble, cunning brigand, master of close-quarters combat."
		},
		{
			name = "Subtlety",
			icon = "Interface\\Icons\\ability_stealth",
			role = "DAMAGER",
			description = "A master of stealth who excels in the art of moving unseen and delivering sudden, deadly strikes."
		},
	},
	["PRIEST"] = {
		{
		...
		},
		{
			...
			role = "HEALER",
			description = "A versatile healer, equally adept at healing a single target or entire groups, and can even heal after death."
		},
		{
			name = "Shadow",
			icon = "Interface\\Icons\\spell_shadow_shadowwordpain",
			role = "DAMAGER",
			description = "Uses Shadow magic to annihilate enemies, favoring spells that deal damage over time."
		},
	},
	["DEATHKNIGHT"] = {
		{
			...
			role = "DAMAGER",
			description = "A dark conqueror who withstands the assault of his enemies by absorbing their life energy to fuel his attacks."
		},
		{
			name = "Frost",
			icon = "Interface\\Icons\\spell_deathknight_frostpresence",
			role = "DAMAGER",
			description = "A merciless herald of doom who wields the power of runes and strikes with lightning-fast weapon blows."
		},
		{
			name = "Unholy",
			icon = "Interface\\Icons\\spell_deathknight_unholypresence",
			role = "DAMAGER",
			description = "A master of death and decay who spreads disease and commands undead servants."
		},
	},
	["SHAMAN"] = {
		{
			...
			role = "DAMAGER",
			description = "A summoner who bends the destructive forces of the elements to his will."
		},
		{
			name = "Enhancement",
			icon = "Interface\\Icons\\spell_nature_lightningshield",
			role = "DAMAGER",
			description = "A fighter who uses totems and strikes his enemies with weapons empowered by the spirits of the elements."
		},
		{
			name = "Restoration",
			icon = "Interface\\Icons\\spell_nature_magicimmunity",
			role = "HEALER",
			description = "A healer who calls upon the spirits of the ancestors and the purifying power of water to heal his allies' wounds."
		},
	},
	["MAGE"] = {
		{
			...
			role = "DAMAGER",
			description = "Masters arcane energy, bending time and space."
		},
		{
			name = "Fire",
		...
		},
		{
			...
			role = "DAMAGER",
			description = "Through the magic of frost, freezes enemies then shatters them to pieces."
		},
	},
	["WARLOCK"] = {
		{
			...
			role = "DAMAGER",
			description = "A master of fel magic, able to terrify his enemies, drain their strength, and deal damage over time."
		},
		{
			name = "Demonology",
			icon = "Interface\\Icons\\spell_shadow_metamorphosis",
			role = "DAMAGER",
			description = "Masters both fire and Shadow magic, and benefits from the support of powerful demons."
		},
		{
			name = "Destruction",
			icon = "Interface\\Icons\\spell_shadow_rainoffire",
			role = "DAMAGER",
			description = "Summons demonic flames that burn and annihilate enemies."
		},
	},
	["DRUID"] = {
		{
			...
			role = "DAMAGER",
			description = "Transforms into a wise owl and, by balancing the forces of arcane and nature magic, annihilates enemies at range."
		},
		{
			name = "Feral Combat",
			icon = "Interface\\Icons\\ability_racial_bearform",
			role = "DAMAGER",
			description = "Transforms into a cat to claw and bite enemies, making them bleed, or into a mighty bear to protect his allies."
		},
		{
			name = "Restoration",
			icon = "Interface\\Icons\\spell_nature_healingtouch",
			role = "HEALER",
			description = "Uses periodic healing spells to support his allies. \nCan transform into a tree to heal even more effectively."
		},
	},
}
...
SIRUS_TALENT_INFO = {
	...
	["DEATHKNIGHT"] = {
		[1] = {
			...
			Description = "A dark defender who withstands the assault of his enemies, or strikes them with furious attacks while feeding on their life energy.",
			color = {r=1.0, g=0.0, b=0.0},
			role = 5 -- Damager + Tank
		},
		[2] = {
	...
	["DRUID"] = {
		...
		[3] = {
			...
			Description = "Uses periodic healing spells to support allies. Can transform into a tree to heal even more effectively.",
	...
	["PALADIN"] = {
		...
		[2] = {
			...
			Description = "Uses the magic of the Light to protect himself and his allies from enemy attacks.",
			color = {r=0.3, g=0.5, b=1.0},
			role = 4 -- Tank
		},
		[3] = {
	...
	["WARRIOR"] = {
		...
		[3] = {
			...
			Description = "Uses a shield to protect himself and his allies from enemy attacks.",
			color = {r=0.3, g=0.5, b=1.0},
			role = 4 -- Tank
		}
	},
	["DEMONHUNTER"] = {
		...
		[3] = {
			...
			Description = "A fanatical demon fighter, mastering both blades and fel magic. By striking his opponent's soul and body, he summons powerful servants.",
