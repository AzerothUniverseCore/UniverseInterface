...
RESTORE_CHARACTER_INSTRUCTIONS = "\n\n\n\nEven when heroes leave the lands of Azeroth, their story is never truly forgotten.\nThe characters you have deleted are safely preserved and can return to the realm of the living\nat any time.\n\nWhether they have known glory on the battlefields, ventured through the wilds, or\nsimply lived out their own adventure, their journey can resume where it left off.\n\nTake your time to choose the character you wish to bring back.\nOnce restored, they will return to your account and be able to continue their adventure as before.\nYou are free to delete and restore your characters as many times as you wish:\nno story deserves to be forgotten forever.\n\nWhen you are ready to continue their adventure, choose « Restore ».\nIf you have changed your mind, choose « Cancel » and your character will remain in their current state.";
RESTORE_CHARACTER_CONFIRM = "Restore";
RESTORE_CHARACTER_CONFIRM_TEXT = "\n\nDo you want to restore\n|cffffffff%s Level %d %s|r?";
