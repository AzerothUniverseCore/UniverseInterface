...
function SetBackgroundModel(model, race, class)
	...
	if (model == CharacterCreate) then
		...
		elseif(--[[enUS]]race == "(A)Pandaren"or --[[frFR]]race == "(A)Pandaren"or race == "(A)Pandaren") then -- Alliance
			name = "Pandaren";
		elseif(--[[enUS]]race == "(A)Elf Illidari"or --[[frFR]]race == "(A)Elfe Illidari"or race == "(A)Elfe Illidari") then -- Alliance
			name = "DemonHunter";
		elseif(--[[enUS]]race == "(H)Elf Illidari"or --[[frFR]]race == "(H)Elfe Illidari"or race == "(H)Elfe Illidari") then -- Horde
			name = "DemonHunter";
		...
		elseif(--[[enUS]]race == "Lightforged"or --[[frFR]]race == "Sancteforge"or race == "Sancteforge") then
			name = "Draenei";
		elseif(--[[enUS]]race == "Zandalari"or --[[frFR]]race == "Zandalari"or race == "Zandalari") then
			name = "Troll";
		elseif(--[[enUS]]race == "(A)DarkIron"or --[[frFR]]race == "(A)Sombrefer"or race == "(A)Sombrefer") then
			name = "Dwarf";
		elseif(--[[enUS]]race == "(H)DarkIron"or --[[frFR]]race == "(H)Sombrefer"or race == "(H)Sombrefer") then
			name = "Dwarf";
		elseif(--[[enUS]]race == "High Elf"or --[[frFR]]race == "Haut-Elfe"or race == "Haut-Elfe") then
			name = "BloodElf";
		elseif(--[[enUS]]race == "Highmountain"or --[[frFR]]race == "Haut-Roc"or race == "Haut-Roc") then
			name = "Tauren";
		...
		elseif(--[[enUS]]race == "(A)Dracthyr"or --[[frFR]]race == "(A)Dracthyr"or race == "(A)Dracthyr") then -- Alliance
			name = "Dracthyr";
		elseif(--[[enUS]]race == "Maghar"or --[[frFR]]race == "Mag'har"or race == "Mag'har") then -- Horde
			name = "ORCCLAN";
		elseif(--[[enUS]]race == "Kul Tiran"or --[[frFR]]race == "Kultirassien"or race == "Kultirassien") then -- Alliance
			name = "Kultiran";
		end
