...
--		else
			...
			-- PATCH Collection : garde-fou. UnitClass("player")/C_Talent.GetCurrentSpecID()
			-- peuvent renvoyer autre chose qu'un nombre juste apres l'ouverture du Codex
			-- (donnees pas encore pretes), ce qui faisait planter
			-- "Usage: C_Heirloom.SetClassAndSpecFilters(classID, specID)". On reessaiera
			-- au prochain OnShow puisque self.filtersSet reste nil tant que ça echoue.
