...
--	Project:	AzerothUniverseCore / UniverseEmu (Eons)
--	Origin:		Merged from Sirus Game Interface (Nyll) + Universe custom constants
--	Note:		All color helpers use the Universe naming convention (CreateColorRGB / ColorMixinTable)
	...
	["HUNTER"] = {
		{
			...
			role = "DAMAGER",
			description = "Expert des bêtes, capable d'apprivoiser des animaux de toutes sortes et de les utiliser au combat."
		},
		{
			name = "Précision",
			icon = "Interface\\Icons\\Ability_Marksmanship",
			role = "DAMAGER",
			description = "Tireur d'élite, inégalé pour abattre ses ennemis à longue distance."
		},
		{
			name = "Survie",
			icon = "Interface\\Icons\\Ability_Hunter_SwiftStrike",
			role = "DAMAGER",
			description = "Pisteur qui préfère recourir aux poisons, aux explosifs et aux pièges."
		},
	},
	["WARRIOR"] = {
		{
			...
			role = "DAMAGER",
			description = "Maître aguerri des armes à deux mains, qui compte sur sa vitesse et la puissance de ses coups au combat."
		},
		{
			name = "Fureur",
			icon = "Interface\\Icons\\ability_warrior_innerrage",
			role = "DAMAGER",
			description = "Berserker déchaîné combattant une arme dans chaque main. Il abat sur son ennemi une pluie de coups capables de le mettre en pièces."
		},
		{
			name = "Protection",
			icon = "Interface\\Icons\\ability_warrior_defensivestance",
			role = "TANK",
			description = "Défenseur endurant qui utilise un bouclier pour se protéger lui et ses alliés des attaques ennemies."
		},
	},
	["PALADIN"] = {
		{
			...
			role = "HEALER",
			description = "Chevalier habile qui invoque les pouvoirs de la Lumière pour protéger et soigner."
		},
		{
			name = "Protection",
			icon = "Interface\\Icons\\ability_paladin_shieldofthetemplar",
			role = "TANK",
			description = "Gardien intrépide qui utilise la magie de la Lumière pour se protéger lui et ses alliés des attaques ennemies."
		},
		{
			name = "Vindicte",
			icon = "Interface\\Icons\\spell_holy_auraoflight",
			role = "DAMAGER",
			description = "Champion de la justice, qui punit ses ennemis à l'aide de ses armes et de la magie de la Lumière."
		},
	},
	["ROGUE"] = {
		{
			...
			role = "DAMAGER",
			description = "Redoutable expert des poisons, qui achève ses adversaires à coups de dagues empoisonnées."
		},
		{
			name = "Combat",
			icon = "Interface\\Icons\\ability_backstab",
			role = "DAMAGER",
			description = "Bandit agile et rusé, maître du combat rapproché."
		},
		{
			name = "Finesse",
			icon = "Interface\\Icons\\ability_stealth",
			role = "DAMAGER",
			description = "Maître de la discrétion, qui excelle dans l'art de se déplacer sans être vu et de porter des attaques soudaines et mortelles."
		},
	},
	["PRIEST"] = {
		{
			...
			role = "HEALER",
			description = "Utilise la magie pour protéger ses alliés et soigner leurs blessures."
		},
		{
			name = "Sacré",
			icon = "Interface\\Icons\\spell_holy_guardianspirit",
			role = "HEALER",
			description = "Soigneur polyvalent, qui soigne aussi bien une cible unique que des groupes, et peut même soigner après la mort."
		},
		{
			name = "Ombre",
			icon = "Interface\\Icons\\spell_shadow_shadowwordpain",
			role = "DAMAGER",
			description = "Utilise la magie des Ombres pour anéantir ses ennemis, en privilégiant les sorts infligeant des dégâts périodiques."
		},
	},
	["DEATHKNIGHT"] = {
		{
			...
			role = "DAMAGER",
			description = "Conquérant ténébreux qui contient l'assaut de ses ennemis en absorbant leur énergie vitale pour renforcer ses attaques."
		},
		{
			name = "Givre",
			icon = "Interface\\Icons\\spell_deathknight_frostpresence",
			role = "DAMAGER",
			description = "Messager impitoyable du destin, qui utilise le pouvoir des runes et frappe avec des coups d'arme foudroyants."
		},
		{
			name = "Impie",
			icon = "Interface\\Icons\\spell_deathknight_unholypresence",
			role = "DAMAGER",
			description = "Maître de la mort et de la décomposition, qui répand les maladies et contrôle des serviteurs morts-vivants."
		},
	},
	["SHAMAN"] = {
		{
			...
			role = "DAMAGER",
			description = "Invocateur qui soumet à sa volonté les forces destructrices des éléments."
		},
		{
			name = "Amélioration",
			icon = "Interface\\Icons\\spell_nature_lightningshield",
			role = "DAMAGER",
			description = "Combattant qui utilise des totems et frappe ses ennemis avec des armes renforcées par les esprits des éléments."
		},
		{
			name = "Restauration",
			icon = "Interface\\Icons\\spell_nature_magicimmunity",
			role = "HEALER",
			description = "Soigneur qui invoque les esprits des ancêtres et le pouvoir purificateur de l'eau pour soigner les blessures de ses alliés."
		},
	},
	["MAGE"] = {
		{
			...
			role = "DAMAGER",
			description = "Maîtrise l'énergie arcanique, dominant le temps et l'espace."
		},
		{
			name = "Feu",
			icon = "Interface\\Icons\\spell_fire_firebolt02",
			role = "DAMAGER",
			description = "Incinère ses ennemis avec des boules de feu et un souffle de dragon."
		},
		{
			name = "Givre",
			icon = "Interface\\Icons\\spell_frost_frostbolt02",
			role = "DAMAGER",
			description = "Grâce à la magie du givre, gèle ses ennemis puis les brise en morceaux."
		},
	},
	["WARLOCK"] = {
		{
			...
			role = "DAMAGER",
			description = "Expert de la magie noire, capable de terrifier ses ennemis, de leur soutirer leurs forces et de leur infliger des dégâts périodiques."
		},
		{
			name = "Démonologie",
			icon = "Interface\\Icons\\spell_shadow_metamorphosis",
			role = "DAMAGER",
			description = "Maîtrise aussi bien la magie du feu que celle des Ombres, et bénéficie du soutien de puissants démons."
		},
		{
			name = "Destruction",
			icon = "Interface\\Icons\\spell_shadow_rainoffire",
			role = "DAMAGER",
			description = "Invoque des flammes démoniaques qui brûlent et anéantissent ses ennemis."
		},
	},
	["DRUID"] = {
		{
			...
			role = "DAMAGER",
			description = "Se transforme en sage hibou et, en équilibrant les forces de la magie arcanique et de la nature, anéantit ses ennemis à distance."
		},
		{
			name = "Combat féral",
			icon = "Interface\\Icons\\ability_racial_bearform",
			role = "DAMAGER",
			description = "Se transforme en chat pour griffer et mordre ses ennemis en les faisant saigner, ou en puissant ours pour protéger ses alliés."
		},
		{
			name = "Restauration",
			icon = "Interface\\Icons\\spell_nature_healingtouch",
			role = "HEALER",
			description = "Utilise des sorts de soin périodiques pour soutenir ses alliés. \nPeut se transformer en arbre pour soigner encore plus efficacement."
		},
	},
}
...
GUILD_TABARD_EMBLEM_COLOR = {
	[0] = CreateColorRGB(0.40392156862745, 0, 0.12941176470588),
	[1] = CreateColorRGB(0.40392156862745, 0.13725490196078, 0),
	[2] = CreateColorRGB(0.38823529411765, 0.40392156862745, 0),
	[3] = CreateColorRGB(0.31764705882353, 0.40392156862745, 0),
	[4] = CreateColorRGB(0.55686274509804, 0.5921568627451, 0),
	[5] = CreateColorRGB(0.55686274509804, 0.5921568627451, 0),
	[6] = CreateColorRGB(0.2156862745098, 0.40392156862745, 0),
	[7] = CreateColorRGB(0, 0.40392156862745, 0.12156862745098),
	[8] = CreateColorRGB(0, 0.40392156862745, 0.34117647058824),
	[9] = CreateColorRGB(0, 0.28235294117647, 0.40392156862745),
	[10] = CreateColorRGB(0.035294117647059, 0.16470588235294, 0.36470588235294),
	[11] = CreateColorRGB(0.42745098039216, 0, 0.46666666666667),
	[12] = CreateColorRGB(0.36470588235294, 0.035294117647059, 0.30980392156863),
	[13] = CreateColorRGB(0.32941176470588, 0.2156862745098, 0.03921568627451),
	[14] = CreateColorRGB(1, 1, 1),
	[15] = CreateColorRGB(0.062745098039216, 0.082352941176471, 0.090196078431373),
	[16] = CreateColorRGB(0.87450980392157, 0.64705882352941, 0.35294117647059),
}
...
GUILD_TABARD_BORDER_COLOR = {
	...
	[1] = {
		...
		[1] = CreateColorRGB(0.40392156862745, 0.13725490196078, 0),
		[2] = CreateColorRGB(0.38823529411765, 0.40392156862745, 0),
		[3] = CreateColorRGB(0.76078431372549, 0.63137254901961, 0.3921568627451),
		[4] = CreateColorRGB(0.76470588235294, 0.76470588235294, 0.76470588235294),
		[5] = CreateColorRGB(0, 0.40392156862745, 0.34117647058824),
		[6] = CreateColorRGB(0.082352941176471, 0.72549019607843, 1),
		[7] = CreateColorRGB(0.2, 0.67450980392157, 0.95686274509804),
		[8] = CreateColorRGB(0.50196078431373, 0.50196078431373, 1),
		[9] = CreateColorRGB(0.1843137254902, 0.22352941176471, 0.34901960784314),
		[10] = CreateColorRGB(0.37647058823529, 0.24705882352941, 0.41176470588235),
		[11] = CreateColorRGB(0.42745098039216, 0.13725490196078, 0.32941176470588),
		[12] = CreateColorRGB(0.37254901960784, 0.12156862745098, 0.29019607843137),
		[13] = CreateColorRGB(0.77647058823529, 0.4156862745098, 0.14901960784314),
		[14] = CreateColorRGB(0.64313725490196, 0.57647058823529, 0.45882352941176),
		[15] = CreateColorRGB(0.27843137254902, 0.41176470588235, 0.43921568627451),
		[16] = CreateColorRGB(0.83921568627451, 0.81960784313725, 0.094117647058824),
	}
}

GUILD_TABARD_BACKGROUND_COLOR = {
	[0] = CreateColorRGB(1, 0.21960784313725, 0.98039215686275),
	[1] = CreateColorRGB(1, 0.12549019607843, 0.53333333333333),
	[2] = CreateColorRGB(0.40392156862745, 0, 0.12941176470588),
	[3] = CreateColorRGB(1, 0.53725490196078, 0.10588235294118),
	[4] = CreateColorRGB(0.88235294117647, 0.27058823529412, 0),
	[5] = CreateColorRGB(0.69411764705882, 0, 0.18039215686275),
	[6] = CreateColorRGB(0.76862745098039, 0.6078431372549, 0),
	[7] = CreateColorRGB(1, 0.53725490196078, 0.10588235294118),
	[8] = CreateColorRGB(0.68235294117647, 0.29411764705882, 0),
	[9] = CreateColorRGB(0.95294117647059, 0.7921568627451, 0),
	[10] = CreateColorRGB(0.76862745098039, 0.6078431372549, 0),
	[11] = CreateColorRGB(0.5843137254902, 0.42352941176471, 0),
	[12] = CreateColorRGB(1, 1, 0.07843137254902),
	[13] = CreateColorRGB(0.8156862745098, 0.8156862745098, 0.07843137254902),
	[14] = CreateColorRGB(0.63137254901961, 0.63137254901961, 0.07843137254902),
	[15] = CreateColorRGB(0.73725490196078, 0.96470588235294, 0.10588235294118),
	[16] = CreateColorRGB(0.55686274509804, 0.5921568627451, 0),
	[17] = CreateColorRGB(0.34509803921569, 0.50196078431373, 0),
	[18] = CreateColorRGB(0.53333333333333, 0.72941176470588, 0.011764705882353),
	[19] = CreateColorRGB(0.38823529411765, 0.63921568627451, 0),
	[20] = CreateColorRGB(0, 0.50980392156863, 0.058823529411765),
	[21] = CreateColorRGB(0.11764705882353, 1, 0.4078431372549),
	[22] = CreateColorRGB(0.015686274509804, 0.76470588235294, 0.27843137254902),
	[23] = CreateColorRGB(0, 0.40392156862745, 0.12156862745098),
	[24] = CreateColorRGB(0.11764705882353, 0.96862745098039, 0.75686274509804),
	[25] = CreateColorRGB(0.015686274509804, 0.71764705882353, 0.56078431372549),
	[26] = CreateColorRGB(0, 0.56470588235294, 0.38039215686275),
	[27] = CreateColorRGB(0.12941176470588, 0.86274509803922, 1),
	[28] = CreateColorRGB(0, 0.6156862745098, 0.77254901960784),
	[29] = CreateColorRGB(0, 0.38823529411765, 0.56862745098039),
	[30] = CreateColorRGB(0.30196078431373, 0.55686274509804, 0.85490196078431),
	[31] = CreateColorRGB(0.17254901960784, 0.4156862745098, 0.68235294117647),
	[32] = CreateColorRGB(0, 0.2078431372549, 0.50980392156863),
	[33] = CreateColorRGB(0.82745098039216, 0.29019607843137, 0.7843137254902),
	[34] = CreateColorRGB(0.67843137254902, 0.16078431372549, 0.67450980392157),
	[35] = CreateColorRGB(0.52549019607843, 0.058823529411765, 0.60392156862745),
	[36] = CreateColorRGB(0.9921568627451, 0, 0.65098039215686),
	[37] = CreateColorRGB(0.82745098039216, 0, 0.52941176470588),
	[38] = CreateColorRGB(0.63921568627451, 0, 0.4078431372549),
	[39] = CreateColorRGB(1, 0.12549019607843, 0.53333333333333),
	[40] = CreateColorRGB(0.61960784313725, 0, 0.21176470588235),
	[41] = CreateColorRGB(0.40392156862745, 0, 0.12941176470588),
	[42] = CreateColorRGB(0.52941176470588, 0.33333333333333, 0.074509803921569),
	[43] = CreateColorRGB(0.32941176470588, 0.2156862745098, 0.03921568627451),
	[44] = CreateColorRGB(0.30980392156863, 0.13725490196078, 0),
	[45] = CreateColorRGB(0.13725490196078, 0.13725490196078, 0.13725490196078),
	[46] = CreateColorRGB(0.50196078431373, 0.50196078431373, 0.50196078431373),
	[47] = CreateColorRGB(0.70588235294118, 0.73333333333333, 0.65882352941176),
	[48] = CreateColorRGB(0.84313725490196, 0.86666666666667, 0.79607843137255),
	[49] = CreateColorRGB(1, 1, 1),
	[50] = CreateColorRGB(0.98823529411765, 0.4078431372549, 0.56862745098039),
}
...
SIRUS_TALENT_INFO = {
	...
	["DEATHKNIGHT"] = {
		[1] = {
			...
			Description = "Défenseur ténébreux qui contient l'assaut de ses ennemis, ou les frappe avec des attaques déchaînées en se nourrissant de leur énergie vitale.",
			color = {r=1.0, g=0.0, b=0.0},
			role = 5 -- Damager + Tank
		},
		[2] = {
	...
	["DRUID"] = {
		...
		[3] = {
			...
			Description = "Utilise des sorts de soin périodiques pour soutenir ses alliés. Peut se transformer en arbre pour soigner encore plus efficacement.",
	...
	["PALADIN"] = {
		[1] = {
			...
			Description = "Invoque les pouvoirs de la Lumière pour protéger et soigner.",
			color = {r=1.0, g=0.5, b=0.0},
			role = 2 -- Heal
		},
		[2] = {
			...
			Description = "Utilise la magie de la Lumière pour se protéger lui et ses alliés des attaques ennemies.",
			color = {r=0.3, g=0.5, b=1.0},
			role = 4 -- Tank
		},
		[3] = {
	...
	["WARRIOR"] = {
		...
		[3] = {
			...
			Description = "Utilise un bouclier pour se protéger lui et ses alliés des attaques ennemies.",
			color = {r=0.3, g=0.5, b=1.0},
			role = 4 -- Tank
		}
	},
	["DEMONHUNTER"] = {
		...
		[3] = {
			...
			Description = "Combattant fanatique des démons, maîtrisant aussi bien les lames que la magie noire. En frappant l'âme et le corps de son adversaire, il invoque de puissants serviteurs.",
...
S_VIP_STATUS_DATA = {
	[308221] = {
		spellID 	= 308221,
		category 	= 1,
		color 		= CreateColorRGB(0.80, 0.49, 0.19),
	},
	[308222] = {
		spellID 	= 308222,
		category 	= 1,
		color 		= CreateColorRGB(1, 1, 1),
	},
	[308223] = {
		spellID 	= 308223,
		category 	= 1,
		color 		= CreateColorRGB(1, 0.84, 0),
	},
	[308224] = {
		spellID 	= 308224,
		category 	= 2,
	...
	[308227] = {
		spellID 	= 308227,
		category 	= 3,
		color 		= CreateColorRGB(0.47, 1, 0.47),
	},
--[[
	[] = {
		spellID 	= ,
		category 	= 3,
		color 		= CreateColorRGB(0.38, 0.56, 1),
	},
	[] = {
		spellID 	= ,
		category 	= 3,
		color 		= CreateColorRGB(1, 0.3, 0.34),
	},
]]
}
