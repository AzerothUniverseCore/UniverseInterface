...
--	Origin:		Merged from Sirus Game Interface (Nyll) + Universe custom utilities
...
local RAID_CLASS_COLORS = {
	...
	["EVOKER"] = CreateColorRGB(0.20, 0.58, 0.50),
	["TAMER"] = CreateColorRGB(1.0, 1.0, 1.0),
	["WARLOCK"] = CreateColorRGB(0.58, 0.51, 0.79),
	["NECROMANCER"] = CreateColorRGB(0.0275, 0.7608, 0.0157),
	["VENOMANCER"] = CreateColorRGB(0.9608, 0.4902, 0.1255),
	["CHRONOMANCER"] = CreateColorRGB(0.63, 0.73, 0.74),
	["GEOMANCER"] = CreateColorRGB(0.7686, 0.9137, 0.4235),
	["PYROMANCER"] = CreateColorRGB(1.0, 0.3216, 0.0157),
	["PRIEST"] = CreateColorRGB(1.0, 1.0, 1.0),
	["PALADIN"] = CreateColorRGB(0.96, 0.55, 0.73),
	["HERO"] = CreateColorRGB(0.992, 0.773, 0.722),
	["MAGE"] = CreateColorRGB(0.41, 0.8, 0.94),
	["BLOODMAGE"] = CreateColorRGB(1.0, 0.0, 0.0),
	["ROGUE"] = CreateColorRGB(1.0, 0.96, 0.41),
	["MONK"] = CreateColorRGB(0.0, 1.0, 0.60),
	["DEMONHUNTER"] = CreateColorRGB(0.64, 0.19, 0.79),
	["DRUID"] = CreateColorRGB(1.0, 0.49, 0.04),
	["SHAMAN"] = CreateColorRGB(0.0, 0.44, 0.87),
	["WARRIOR"] = CreateColorRGB(0.78, 0.61, 0.43),
	["CHAOSRAVAGER"] = CreateColorRGB(0.7176, 0.6157, 0.2667),
	["DEATHKNIGHT"] = CreateColorRGB(0.77, 0.12 , 0.23),
	["KNIGHT"] = CreateColorRGB(0.9804, 0.8686, 0.0863),
};
