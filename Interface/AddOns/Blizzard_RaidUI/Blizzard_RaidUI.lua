...
do
	...
	RAID_CLASS_BUTTONS["PETS"]			= { button = 25, coords = {0, 1, 0, 1} };
	RAID_CLASS_BUTTONS["MAINTANK"]		= { button = 26, coords = {0, 1, 0, 1} };
	RAID_CLASS_BUTTONS["MAINASSIST"]	= { button = 27, coords = {0, 1, 0, 1} };
end
